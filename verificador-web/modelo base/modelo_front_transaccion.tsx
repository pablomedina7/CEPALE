...
export function TransactionVerifier() {
  ...
  const handleSearchTransaction = () => {
    ...
    if (foundTransaction) {
      // Resaltar la transacción encontrada
      console.log("Transacción encontrada:", foundTransaction)
    }
  }
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                automáticamente la integridad y autenticidad de cada transacción contra nuestra base de datos segura.
              </p>
            </div>
          </div>
        </CardContent>
